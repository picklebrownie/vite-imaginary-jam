...
function App() {
  ...
  return (
    <>
      ...
      <footer className="bg-gradient-to-b from-transparent to-slate-300">
        <div className="mx-auto px-12 py-12 md:flex md:items-center md:justify-between lg:px-12 xl:px-24">
          <div className="flex justify-center space-x-6 md:order-2">
            <a key="Facebook" href="#" className="text-gray-800 hover:text-blue-600">
                <span className="sr-only">Facebook</span>
                <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6 transition ease-in-out duration-300 hover:scale-125" aria-hidden="true">
                  <path
                    fillRule="evenodd"
              ...
              <a key="Instagram" href="#" className="text-gray-800 hover:text-rose-500">
              ...
              <a key="Twitter" href="#" className="text-gray-800 hover:text-blue-400">
                <span className="sr-only">Twitter</span>
                <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6 transition ease-in-out duration-300 hover:scale-125" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a key="GitHub" href="https://github.com/picklebrownie" className="text-gray-800 hover:text-violet-700">
              ...
              <a key="YouTube" href="#" className="text-gray-800 hover:text-red-600">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5 text-gray-900">
              &copy; 2023 Imaginary Jam. Created by Kayla.
            </p>
          </div>
        </div>
      </footer>
